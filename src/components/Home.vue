...
<div>
  <div class="animated fadeIn">
    ...
    <pre class="css-code" style="height: 40vh; overflow-y: scroll;"><em class="comment">/* 
 * 
 * hmmmm                                               
 *                                             
...
<em class="selector">.css-code </em>{<em class="key"> 
  width</em>:<em class="value"> 50%</em>;<em class="key">
  ...
  box-sizing</em>:<em class="value"> border-box</em>;
}                                              
<em class="comment">/* 
 *  
