...
export const projects = [
  { title: 'remote claude', subtitle: 'claude code on your phone', year: '2026', tags: ['Swift', 'SwiftUI', 'Node', 'Cloudflare', 'Open Source'], description: 'An iOS app to access and control Claude Code running on your Mac or a Linux server — like Codex mobile, but for Claude. Open source.', link: 'https://testflight.apple.com/join/x27e26xs', github: 'https://github.com/soliblue/cloude', status: 'graveyard' },
  { title: 'machtblick', subtitle: 'bundestag transparency', year: '2026', tags: ['React', 'TanStack', 'TypeScript', 'Drizzle', 'ETL'], description: 'A transparency platform for the German Bundestag. It makes votes, members, parties, speeches, questions, donations, and party histories easier to search and understand, with AI-assisted summaries.', link: 'https://apps.apple.com/de/app/machtblick/id6787755187', linkLabel: 'App Store', website: 'https://machtblick.de/', status: 'live' },
