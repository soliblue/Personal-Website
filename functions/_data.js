...
export const projects = [
  ...
  { title: 'machtblick', subtitle: 'bundestag transparency', year: '2026', tags: ['React', 'TanStack', 'TypeScript', 'Drizzle', 'ETL'], description: 'A transparency platform for the German Bundestag. It makes votes, members, parties, speeches, questions, donations, and party histories easier to search and understand, with AI-assisted summaries.', link: 'https://apps.apple.com/de/app/machtblick/id6787755187', linkLabel: 'App Store', status: 'live' },
